...
public class OI {
    ...
    public OI() {
        ...
        yButton.whenPressed(new ClapOff());
        xButton = new JoystickButton(driveStick, 3);
        xButton.whenPressed(new ClapOn());
        aButton = new JoystickButton(driveStick, 1);
        aButton.whenPressed(new StartElevator());
        ...
        SmartDashboard.putData("ClapOn", new ClapOn());
        SmartDashboard.putData("ClapOff", new ClapOff());
